export const skillsData = {
    ...
    "Programming Languages": [
        ...
        { name: "Python", icon: "/assets/icons/python.png", proficiency: "Intermediate", experience: "2+ years", projects: ["Buckshot Roulette", "Space Invaders", "Restaurant Manager (GUI with Database)", "Snake Xenzin"], description: "Used for building scalable backend services."},
        { name: "C++", icon: "/assets/icons/c++.png", proficiency: "Intermediate", experience: "1+ years", projects: ["TODO", "TODO"], description: "Used for building scalable backend services."},
